defmodule LifecellIpTelephonyProtocol.RedisManager do
  @moduledoc false
  ...
  def command(command) when is_list(command) do
    pool_size = String.to_integer(Application.get_env(:lifecell_ip_telephony_protocol, LifecellIpTelephonyProtocol.RedisManager)[:pool_size])
