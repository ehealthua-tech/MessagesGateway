defmodule LifecellSmsProtocol.RedisManager do
  @moduledoc false
  ...
  def command(command) when is_list(command) do
    pool_size =  String.to_integer(Application.get_env(:lifecell_sms_protocol, LifecellSmsProtocol.RedisManager)[:pool_size])
