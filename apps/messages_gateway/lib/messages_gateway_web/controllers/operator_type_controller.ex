defmodule MessagesGatewayWeb.OperatorTypeController do
  ...
  def deactivate(conn, %{"resource" => %{"operator_type_id" => operator_type_id}}) do
    with {:ok, _} <- OperatorTypesRequests.change_status(%{id: operator_type_id, active: @operator_inactive})
      do
