defmodule MessagesGateway.UUID do
  ...
  @spec generate_uuid() :: result when
          result: {:ok, String.t()}
  ...
  @spec bytes_to_string(byte) :: result when
          byte: <<_::128>>,
          result: String.t()
  ...
  @spec binary_data_to_list(data, acc) :: result when
          data: [binary()] | [],
          acc: [] | [String.t()],
          result: [String.t()]
  ...
  @spec list_to_hex_str(data) :: result when
          data: [integer()]| [],
          result: [integer()] | []
  ...
  @spec to_hex_str(hex) :: result when
          hex: byte(),
          result: [integer()]
